    ...
    if($count>0)
    {
        ...
        if($numr>0)
        {
            while($row=mysqli_fetch_assoc($details))
            {
                ...
                $GLOBALS['phone1']= $row['phone'];
                  // $GLOBALS['images']='img.jpg';
                  $GLOBALS['images']= $row['filename'];
                ...
                <div class="col-lg-4">
                  <div class="card mb-4">
                    <div class="card-body text-center">
                      ...
                      <p class="text-muted mb-4">NUZVIDU KRISHNA DISTRICT 521202</p>
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" name="nm1">  </p>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" name="em1">'.
                          "$email1".' </p>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" id="ph2" name="ph1">'.
                          "$phone1".' </p>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" name="lb1">'.
                          "$phone1".' </p>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" name="ad1">IIIT NUZVIDU CAMPUS</p>
                        </div>
                      </div>
                    </div>
                  </div>
